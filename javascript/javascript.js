...
class GlowCookies {
    ...
    start(languaje, obj) {
        ...
        if (languaje === 'en') {
            ...
            // Banner
            this.banner = {
                description: obj.bannerDescription || "Ce site utilise des cookies 🍪 afin d'en analyser le trafic.",
                linkText: obj.bannerLinkText || 'En savoir plus sur les cookies',
                link: obj.policyLink || '#link',
                background: obj.bannerBackground ||'#fff',
                color: obj.bannerColor || '#505050',
                heading: obj.bannerHeading || '',
                acceptBtn: {
                    text: obj.acceptBtnText || 'Accepter les cookies',
                    background: obj.acceptBtnBackground || '#24273F',
                    color: obj.acceptBtnColor || '#fff'
                },
                rejectBtn: {
                    text: obj.rejectBtnText || 'Refuser',
                    background: obj.rejectBtnBackground || '#E8E8E8',
                    color: obj.rejectBtnColor || '#636363'
                },
                manageCookies: {
